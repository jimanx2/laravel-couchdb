...
* CouchDB does not have the concept of collection as MongoDB, so we are using "collections" by adding an attribute (record_type) in every single document. Please, treat record_type as a reserved attribute. Use of collections is not optional.
